    ...
    <section id="pricing">
      <div className="mx-auto flex max-w-screen-xl flex-col gap-8 px-4 py-14 md:px-8">
        ...
        <div className="flex w-full items-center justify-center space-x-2">
          ...
          />
          <span>Annual</span>
          <span className="inline-block rounded-full bg-black px-2.5 py-1 text-[11px] leading-5 font-semibold tracking-wide whitespace-nowrap text-white uppercase dark:bg-white dark:text-black">
            2 MONTHS FREE ✨
          </span>
        </div>
