            ...
            <div className="grid md:grid-cols-2 gap-8">
              {serviceCategories.map((category, index) => {
                ...
                return (
                  <Card 
                    key={index}
                    className="glass-card border-0 hover:shadow-2xl transition-all duration-300 animate-slide-in-up overflow-hidden"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
                    <CardContent className="p-0">
                      {/* Category Image */}
                      <Link to={category.link} className="group block relative overflow-hidden">
                        <div className="relative h-64 overflow-hidden">
                          ...
                          <div className="absolute top-6 right-6">
                            <ArrowRight className="w-8 h-8 text-white group-hover:translate-x-1 transition-all duration-300" />
                          </div>
                          
                          {/* Title and description on image */}
                          <div className="absolute bottom-0 left-0 right-0 p-6">
                            <h2 className="text-3xl font-display font-bold mb-2 text-white group-hover:text-primary transition-colors">
                              {category.title}
                            </h2>
